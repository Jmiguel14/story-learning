export const STORIES = [
  ...
  },
  {
    ...
    description: "El padre Almeida era un fraile franciscano conocido por su espíritu inquieto. De noche, escapaba del convento para disfrutar de fiestas y aventuras en Quito. Una madrugada, al descender por la ventana, pasó frente a un Cristo tallado en piedra que lo miró fijamente. Con voz profunda le dijo: “¿Hasta cuándo, padre Almeida?”. El fraile quedó paralizado de miedo. Desde ese momento cambió su vida: abandonó los placeres mundanos, se dedicó a la oración y a servir a los pobres. Su historia quedó como ejemplo de arrepentimiento, recordando que siempre hay oportunidad de enmendarse.",
  },
  {
    id: 9,
