export const STORIES = [
  {
    ...
    splittedDescription: [
      ...
      "sola hacia el río y desapareció, dejando su recuerdo como",
      "para los incrédulos.",
    ],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      ", cayó al suelo desmayado. Al despertar, estaba solo, con la ropa rota y el corazón",
      ". Desde entonces, en pueblos y ciudades del Ecuador se cuenta que la Dama Tapada",
      "a los hombres mujeriegos.",
    ],
    wordsToCompleteWithSinonim: [
      ["bellísima", "hermosísima"],
      ["conquistado", "seducido"],
      ["fragancia", "perfume"],
      ["Horrorizado", "Espantado"],
      ["acelerado", "palpitando"],
      ["castiga", "condena"],
    ],
  },
  { 
    ...
    splittedDescription: [
      ...
      "por otro adorno, pero el cielo se oscureció, cayó una tormenta y la ciudad quedó envuelta en sombras.",
      ", los quiteños devolvieron el gallo a su lugar. Desde entonces, permanece allí,",
      ", protegiendo a los habitantes con su canto",
      ", eterno y misterioso.",
    ],
    wordsToCompleteWithSinonim: [
      ["guardián", "protector"],
  ...
  { 
    ...
    splittedDescription: [
      ...
      "sobrenatural, casi hasta quitarle el aire. Los hombres que intentan huir escuchan detrás de sí su risa", // macabra
      ", burlona, que hiela la sangre. Muchos la describen alta, hermosa y", // atractiva
      ", pero su presencia anuncia desgracia. Dicen que la Viuda", // reprende
      "especialmente a los hombres", // ebrios
      "e", // infieles
      ", recordándoles que la muerte puede estar esperándolos en cualquier camino nocturno.",
    ],
    wordsToCompleteWithSinonim: [
      ["luto", "negro"],
      ["fuerza", "vigor"],
  ...
  { 
    ...
    splittedDescription: [
      ...
      ". Le gusta", // molestar
      "a los niños escondiéndoles los juguetes y", // trenzando
      "el cabello de las muchachas mientras duermen. Algunos dicen que", // enamora
      "a las jóvenes, haciéndolas perderse en el monte con su música de silbidos. Para espantarlo, los abuelos aconsejan dejar un sombrero nuevo en el patio. El duende no resiste la", // tentación
      ": se prueba el sombrero, baila alegremente y olvida a la persona que perseguía. Aunque muchos lo", // temen
      ", otros lo consideran un ser juguetón que solo busca un poco de diversión.",
    ],
    wordsToCompleteWithSinonim: [
      ["traviesa", "pícara"],
      ["molestar", "fastidiar"],
      ["trenzando", "entrelazando"],
      ["enamora", "cautiva"],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      ", pero antes del amanecer, Cantuña escondió en secreto una piedra. Cuando el diablo regresó, vio que la obra estaba ", // incompleta
      ". ", // Furioso
      ", exigió el alma prometida, pero Cantuña respondió que el trato no estaba cumplido. El diablo desapareció entre gritos y ", // humo
      ". Hasta hoy, los muros de San Francisco guardan el recuerdo de aquel ", // ingenioso
      " indígena.",
    ],
    wordsToCompleteWithSinonim: [
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      ". Sus lamentos estremecen el corazón: “¡Ay, mis hijos!”. Los ancianos advierten que, si sus gritos suenan lejos, en realidad está cerca, y si parecen", // cercanos
      ", está lejos. Quien la sigue queda atrapado por el miedo o enloquece de espanto. Se dice que la Llorona busca a sus hijos", // perdidos
      ", arrastrando su pena eterna. Por eso, los cuencanos evitan caminar solos de noche, pues nadie sabe cuándo su llanto atraviesa las calles, anunciando tristeza y", // desgracia
      "en silencio.",
    ],
    wordsToCompleteWithSinonim: [
      ["empedradas", "adoquinadas"],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      " en las calles de Quito. Una madrugada, al bajar por la ventana, se encontró con un Cristo de piedra que lo miró ", // fijamente
      ". De pronto, escuchó una voz profunda: “¿Hasta cuándo, padre Almeida?”. El fraile quedó ", // paralizado
      " por el miedo. Desde entonces, cambió su vida: dejó atrás los placeres mundanos y se dedicó a la oración y a ayudar a los pobres. Su historia es un ", // ejemplo
      " de arrepentimiento y muestra que siempre hay ", // oportunidad
      " para cambiar.",
    ],
    wordsToCompleteWithSinonim: [
      ["inquieto", "intranquilo"],
      ["aventuras", "experiencias"],
      ["fijamente", "intensamente"],
      ["paralizado", "inmóvil"],
      ["ejemplo", "modelo"],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      "y humo. Los ancianos dicen que es el alma de un hacendado cruel que ", // maltrató
      "a los campesinos. Condenado por su avaricia, vaga convertido en animal embrujado. Muchos aseguran haberlo visto, pero pocos se ", // atreven
      "a hablar de él, temiendo que vuelva a ", // cruzarse
      "en su camino.",
    ],
    wordsToCompleteWithSinonim: [
      ["arrastra", "jala"],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      "al día siguiente. Los vecinos dicen que es un espíritu disfrazado para ", // engañar
      "a los curiosos. Su canto suena ", // extraño
      ", como un ", // lamento
      "humano. Quien logra verla debe correr sin mirar atrás, porque la gallina atrae la mala suerte. Pese a las ", // advertencias
      ", algunos aún intentan encontrarla, fascinados por su ", // misterio
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      "de una mujer que grita: “¡Ay, mis hijos!”. La tradición cuenta que fue una madre que, en un arranque de ", // dolor
      ", ahogó a sus pequeños en un río. ", // Arrepentida
      ", vaga eternamente ", // buscándolos
      ". Los que la han visto describen su vestido blanco y su rostro cubierto por un velo. Se dice que aparece cerca de ríos y lagunas, arrastrando cadenas y lágrimas. Su lamento es un presagio de muerte o desgracia para quien lo escuche. Por eso, pocos se atreven a caminar solos de noche.",
    ],
    wordsToCompleteWithSinonim: [
      ["silenciosas", "calladas"],
      ["desgarrador", "conmovedor"],
      ["dolor", "pena"],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      ": do-re-mi-fa-so-la-si. Si el silbido se oye cerca, el espíritu está lejos; si se escucha lejos, está junto a ti. Dicen que fue un hijo que mató a su padre y, como castigo, fue condenado a cargar sus ", // huesos
      "eternamente. Aparece alto, flaco, con un saco en la espalda. Se dice que persigue a los hombres ", // borrachos
      "y mujeriegos, recordándoles su ", // pecado
      ". Su presencia es tan ", // temida
      "que basta escuchar el silbido para correr despavorido.",
    ],
    wordsToCompleteWithSinonim: [
      ["silbar", "chiflar"],
      ["inconfundible", "inimitable"],
      ["huesos", "restos"],
      ["borrachos", "ebrios"],
      ["pecado", "falta"],
      ["temida", "temible"],
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      "el pelo durante la noche. Las jóvenes ", // embrujadas
      "no pueden dormir ni comer, y se consumen lentamente. Para librarse de él, las familias deben cortarles el cabello o ", // bendecir
  ...
  },
  {
    ...
    splittedDescription: [
      ...
      ", persiguiéndolos hasta arrancarles el alma con un grito ", // aterrador
